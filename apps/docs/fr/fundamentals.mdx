...
<CardGroup cols={2}>
  <Card title="Démarrage rapide" icon="rocket" href="/fr/quickstart">
    Lancez votre première intégration en quelques minutes.
  </Card>
  <Card title="Instances WhatsApp" icon="message" href="/fr/guides/instances">
    Comprendre comment récupérer et utiliser la bonne instance.
  </Card>
  <Card title="Envoyer un message" icon="paper-plane" href="/fr/guides/send-message">
    Voir les vrais payloads d'envoi les plus courants.
  </Card>
  <Card title="Webhooks" icon="webhook" href="/fr/guides/webhooks">
    Recevoir les événements MsgFlash dans votre système.
  </Card>
</CardGroup>
