...
description: Équipes Pro et Plus, invitations, clés API d'équipe et en-tête X-Team-Id pour l'API publique.
---

## Qui peut utiliser les équipes ?

- **Créer une équipe :** uniquement les titulaires d'abonnement **Pro** ou **Plus**.
- **Plafonds :** Pro — jusqu'à **2** équipes possédées, **4** sièges par équipe (propriétaire inclus). Plus — jusqu'à **4** équipes possédées, **8** sièges par équipe.
- **Inviter** n'importe quelle adresse e-mail (y compris Free/Starter ou sans compte).
