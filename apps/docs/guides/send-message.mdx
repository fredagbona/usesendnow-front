...
<Note>
Depuis la console MsgFlash, les médias peuvent être préparés via un upload temporaire avant l’envoi final. Voir [Uploads média temporaires](/guides/media-uploads).
</Note>
