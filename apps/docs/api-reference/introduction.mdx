...
```txt
https://api.msgflash.com/api/v1/messages/send
https://api.msgflash.com/api/v1/templates
https://api.msgflash.com/api/v1/contacts
https://api.msgflash.com/api/v1/billing/usage
```
