...
const EN: LandingMessages = {
  ...
  pricing: {
    ...
    plans: [
      { name: "Free", price: "€0", secondaryPrice: "", desc: "Test the infrastructure and connect a first number.", cta: "Get started", features: ["1 instance", "500 messages per month", "500 API requests / month", "1 API key", "3 webhook endpoints", "10 contact groups", "Campaigns: yes", "Number lookups: yes", "Webhooks: yes", "Voice notes: yes", "Teams: no workspace creation — join a team when invited"] },
      { name: "Pro", price: "€19", secondaryPrice: "", desc: "For teams sending more, automating more, and monitoring better.", cta: "Subscribe", features: ["5 instances", "50,000 messages per month", "150,000 API requests / month", "5 API keys", "15 webhook endpoints", "50 contact groups", "Campaigns: yes", "Number lookups: yes", "Webhooks: yes", "Voice notes: yes", "Teams: up to 2 workspaces you own, 4 seats each"] },
      { name: "MAX", price: "€39", secondaryPrice: "", desc: "For high volume, advanced workflows, and multi-number operations.", cta: "Subscribe", features: ["20 instances", "150,000 messages per month", "500,000 API requests / month", "10 API keys", "50 webhook endpoints", "Unlimited contact groups", "Campaigns: yes", "Number lookups: yes", "Webhooks: yes", "Voice notes: yes", "Teams: up to 4 workspaces you own, 8 seats each"] },
    ],
